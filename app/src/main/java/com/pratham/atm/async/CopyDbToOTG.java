...
import static com.pratham.atm.database.AppDatabase.DB_NAME;
...
public class CopyDbToOTG extends AsyncTask {
    ...
    protected Object doInBackground(Object[] objects) {
        try {
            ...
            DocumentFile fca_backup_file = rootFile.findFile("ATM_Backup_Data");
            if (fca_backup_file == null)
                fca_backup_file = rootFile.createDirectory("ATM_Backup_Data");
