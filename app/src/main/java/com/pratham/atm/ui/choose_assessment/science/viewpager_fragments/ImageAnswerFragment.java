...
import com.pratham.atm.custom.custom_dialogs.ChooseImageDialog;
...
import com.pratham.atm.utilities.RealPathUtil;
...
//                createDirectoryAndSaveFile(bitmap, imageFileName);
                ...
                else assessmentAnswerListener.setAnswerInActivity("", path, scienceQuestion.getQid(), null);
...
//                selectedImage.setImageBitmap(photo);
                ...
                if(!scienceQuestion.getUserAnswer().equalsIgnoreCase(""))
                assessmentAnswerListener.setAnswerInActivity("", scienceQuestion.getUserAnswer(), scienceQuestion.getQid(), null);
                else assessmentAnswerListener.setAnswerInActivity("", path+"/"+fileName, scienceQuestion.getQid(), null);
