...
import com.pratham.atm.domain.Modal_RaspFacility;
...
import com.pratham.atm.services.LocationService;
import com.pratham.atm.utilities.Assessment_Constants;
import com.pratham.atm.utilities.Assessment_Utility;
import com.pratham.atm.utilities.FileUtils;
import com.pratham.atm.utilities.SDCardUtil;
...
import static com.pratham.atm.ui.splash_activity.SplashActivity.appDatabase;
import static com.pratham.atm.utilities.Assessment_Constants.CURRENT_VERSION;
                            ...
                            try {
                                ...
                                if (content_cursor.moveToFirst()) {
                                    while (!content_cursor.isAfterLast()) {
                                        ...
                                        detail.setQuestion3Rating(content_cursor.getString(content_cursor.getColumnIndex("FullName")));
                                        detail.setQuestion3Rating(content_cursor.getString(content_cursor.getColumnIndex("Gender")));
                                        detail.setQuestion3Rating(content_cursor.getString(content_cursor.getColumnIndex("Age")));
                                        detail.setSentFlag(content_cursor.getInt(content_cursor.getColumnIndex("sentFlag")));
                                        contents.add(detail);
                                        content_cursor.moveToNext();
                                    }
